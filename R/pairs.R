...
#' @param \dots other graphical parameters (see \code{\link[graphics]{par}}).
...
#' terrain.colors(30)}.
#' @param margins character; margins for the contour plots. Possible margins
...
#' @param margins.par parameter(s) of the distribution of the margins (of the
