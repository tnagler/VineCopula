...
#' 
#' This function evaluates the conditional distribution function (h-function)
...
#' object \code{obj}, the alternative version \cr \preformatted{BiCopHfunc(u1,
#' u2, obj)} can be used.
#' 
...
#' care).
#' @return \item{hfunc1}{Numeric vector of the conditional distribution
