...
#' BB1, BB6, BB7, BB8, Tawn type 1 and type 2; default: \code{par2 = 0}).
...
#' \item{family}{Copula family} \item{par, par2}{Copula parameter(s).} Objects
#' of this class are returned by the \code{\link{BiCopEst}} and
#' \code{\link{BiCopSelect}} functions.
#' @author Thomas Nagler
#' @seealso \code{\link{BiCopPDF}}, \code{\link{BiCopHfunc}},
#' \code{\link{BiCopSim}}, \code{\link{BiCopEst}}, \code{\link{BiCopSelect}},
